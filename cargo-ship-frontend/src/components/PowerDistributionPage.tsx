/**
 * PowerDistributionPage 组件 - 配电系统监控页面（重构版）
 *
 * 功能说明：
 * - 采用监控墙模式重构的配电系统监控页面
 * - 整合直流配电板的实时监控数据
 * - 使用MonitoringWall组件实现响应式网格布局
 * - 使用DedicatedAlarmZone组件显示配电系统专属告警
...
import { Power, Home, ChevronRight, Wifi, WifiOff, Loader2 } from 'lucide-react';
 ...
 * 直流配电板设备ID
 */
const DCPD_EQUIPMENT_ID = 'SYS-DCPD-001';

/**
 * 页面标题
 */
const PAGE_TITLE = '配电系统监控';
...
const BREADCRUMBS = [
  ...
  { label: PAGE_TITLE, path: '/monitoring/power' },
];
...
// ============================================================================
// PowerDistributionPage 组件
// ============================================================================

/**
 * PowerDistributionPage - 配电系统监控页面
 *
 * 采用监控墙模式的标准实现，展示直流配电板监控
 */
export const PowerDistributionPage: React.FC = () => {
  // --------------------------------------------------------------------------
  // 状态管理
  // --------------------------------------------------------------------------
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900/20 to-gray-900 p-6">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-300 mt-1 font-medium italic">设备ID: {DCPD_EQUIPMENT_ID}</p>
              </div>
            </div>
        ...
        >
          <DedicatedAlarmZone
            equipmentIds={DCPD_EQUIPMENT_ID}
            maxItems={10}
            className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700/50"
          />
        </motion.div>
